...
enum class EDamageTypeCategory : uint8_t
{
	...
	Damage_Rotor                   = 51,
	Damage_MotorGlider             = 52,
	Damage_Gun_Penetrate_BRDM      = 53,
	Damage_Explosion_GasPump       = 54,
	Damage_MAX                     = 55
};
...
enum class ECheatType : uint8_t
{
	...
	InvalidDriverFire              = 71,
	InvalidVehicleOverlap          = 72,
	InvalidViewRotation            = 73,
	VerifyAim                      = 74,
	CHKSUM_GUN                     = 75,
	CHKSUM_PUNCH                   = 76,
	CHKSUM_MELEE                   = 77,
	...
	VHC_ED                         = 123,
	VHC_SERVERSIMUL                = 124,
	VHC_SIMULATION_ACTIVATE        = 125,
	VHC_SIMULATION_DEACTIVATE      = 126,
	VHC_TRY_BYPASS_SERVERSIMUL     = 127,
	VHC_BYPASSED_SERVERSIMUL       = 128,
	VHC_FORCE_SERVERSIMUL          = 129,
	VHC_FORCE_SERVERSIMUL_ACTIVATE = 130,
	VHC_FORCE_SERVERSIMUL_DEACTIVATE = 131,
	CK_ACTIVATE                    = 132,
	CK_DEACTIVATE                  = 133,
	AntiCheatKick_WallHack         = 134,
	AntiCheatKick_ESP              = 135,
	AntiCheatKick_SpeedHack1       = 136,
	AntiCheatKick_SpeedHack2       = 137,
	AntiCheatKick_SpeedHack3       = 138,
	AntiCheatKick_PLFC             = 139,
	AntiCheatKick_TCFC             = 140,
	AntiCheatKick_HL               = 141,
	AntiCheatKick_OS               = 142,
	AntiCheatKick_FC               = 143,
	VehicleSimulation_PLFC         = 144,
	VehicleSimulation_TCFC         = 145,
	VehicleSimulation_HL           = 146,
	VehicleSimulation_OS           = 147,
	VehicleSimulation_FC           = 148,
	CC_ACTIVATE                    = 149,
	CC_DEACTIVATE                  = 150,
	CC_FORCE_ERROR_CORRECTION      = 151,
	QS_AJ                          = 152,
	QS_STAND                       = 153,
	QS_CROUCH                      = 154,
	QS_PRONE                       = 155,
	...
	ESPLog                         = 170,
	ESPRatioLog                    = 171,
	HighLocationVehicle            = 172,
	HighLocationBoat               = 173,
	UnderLandscapeBoat             = 174,
	UnderLandscapeVehicle          = 175,
	UnderLandscapeCharacter        = 176,
	BC_BoatCorrection              = 177,
	HBR_InvalidDashDistance        = 178,
	UNC_ACTIVATE                   = 179,
	UNC_DEACTIVATE                 = 180,
	UncAddUserFail                 = 181,
	UncSetUserInfoFail             = 182,
	UncDeleteUserFail              = 183,
	UncGetCookieFail               = 184,
	UncCookieVerifyFail            = 185,
	UncCookieNotRespond            = 186,
	UncUnknown                     = 187,
	None                           = 188,
	ECheatType_MAX                 = 189
};
...
// Enum TslGame.EAscenderRopeStatus
enum class EAscenderRopeStatus : uint8_t
{
	EARS_NeedsAscender             = 0,
	EARS_AscenderAttached_Unoccupied = 1,
	EARS_AscenderAttached_Occupied = 2,
	EARS_MAX                       = 3
};
...
enum class EAscenderDirection : uint8_t
{
	AscenderUp                     = 0,
	AscenderDown                   = 1,
	EAscenderDirection_MAX         = 2
};


// Enum TslGame.EAscenderRopeSound
enum class EAscenderRopeSound : uint8_t
{
	Player_JumpOn                  = 0,
	Player_JumpOff                 = 1,
	Player_MAX                     = 2
...
// Enum TslGame.ENavLinkAction
enum class ENavLinkAction : uint8_t
{
	NavLink_None                   = 0,
	NavLink_Ascender               = 1,
	NavLink_MAX                    = 2
...
// Enum TslGame.EAscenderSpawnPointType
enum class EAscenderSpawnPointType : uint8_t
{
	SpawnPointType_INVALID         = 0,
	SpawnPointType_Detach_LOWER    = 1,
	SpawnPointType_Detach_UPPER    = 2,
	SpawnPointType_Attach_LOWER    = 3,
	SpawnPointType_Attach_UPPER    = 4,
	SpawnPointType_MAX             = 5
};
...
// Enum TslGame.EFoodTruckAwning
enum class EFoodTruckAwning : uint8_t
{
	Open                           = 0,
	Closed                         = 1,
	EFoodTruckAwning_MAX           = 2
};
